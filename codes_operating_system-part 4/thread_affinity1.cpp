...
struct AlignedAtomic {
  alignas(64) std::atomic<int> val = 0;    //making atomic variable that ibuilts support locking 
//   this implies data will not get courupted
};
...
void thread_affinity() {
  ...
  // Work function for our threads increast the value of val +1 2^20 times
